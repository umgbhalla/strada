...
export function convertAttributes(kvs: KeyValue[] | undefined): Record<string, string> {
...
export function convertExemplars(exemplars: Exemplar[] | undefined): {
  ...
  return {
    exemplars_filtered_attributes: exemplars.map((e) => convertAttributes(e.filteredAttributes)),
...
export function getNumberValue(dp: { asDouble?: number; asInt?: string }): number {
