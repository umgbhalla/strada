/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 59bfaa71b0b5fc33cdef56c13fba5b29)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRADA_TOKEN">> {}
}
