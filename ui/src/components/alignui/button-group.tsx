...
import { PolymorphicComponentProps } from '@strada.sh/ui/src/utils/polymorphic.ts';
...
export const buttonGroupVariants = tv({
  slots: {
    ...
    item: [
      // base
      'group relative flex items-center justify-center whitespace-nowrap bg-background text-center text-muted-foreground outline-hidden',
  ...
  variants: {
    size: {
      small: {
        item: [
          // base
          'h-9 gap-4 px-4 text-sm font-medium',
          // radius
      ...
      xsmall: {
        item: [
          // base
          'h-8 gap-3.5 px-3.5 text-sm font-medium',
          // radius
          'first:rounded-l-lg last:rounded-r-lg',
        ],
        icon: [
      ...
      xxsmall: {
        item: [
          // base
          'h-6 gap-3 px-3 text-xs font-medium',
          // radius
