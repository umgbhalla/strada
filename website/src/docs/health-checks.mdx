...
| `--interval` | `5` | Check interval in minutes (minimum 5) |
...
This checks every 10 minutes, allows up to 5 seconds for a response, alerts after 3 consecutive failures, and waits 30 minutes before re-alerting.
