...
|---|---|---|
| `otel_analytics_pages` | Top pages, browsers, bots, devices, countries, languages, referrers, pageview histogram | `ProjectId, ServiceName, Domain, Date, Device, Browser, BotName, Country, Language, Pathname, Referrer` |
...
BotName         LowCardinality(String)     -- 'ChatGPT', 'Claude', 'Perplexity', 'Gemini', 'Copilot', 'Meta', 'other-bot', or '' for humans
