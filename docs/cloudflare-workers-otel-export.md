...
description: Reference for Cloudflare Workers OpenTelemetry traces and logs, with payload examples, attribute-by-attribute notes, and query recipes for agents using Strada.
---
